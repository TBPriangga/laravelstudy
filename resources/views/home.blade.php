            ...
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        ...
                        <img src="{{ asset('image/ajii.png') }}" alt="" class="h-12 w-auto" />
                    </a>
                </div>
                        ...
                        <div class="relative">
                            ...
                            <button @click="open = !open" class="flex items-center space-x-3 focus:outline-none">
                                ...
                                <img src="{{ Auth::user()->avatar ?? asset('image/default-avatar.svg') }}"
                                    alt="Avatar" class="w-9 h-9 rounded-full border border-gray-600 object-cover">
                            ...
                            <div class="mt-6 flow-root">
                                <div class="-my-6 divide-y divide-white/10">
                                    ...
                                    <div class="py-6">
                                        @auth
                                            <span
                                                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-indigo-400">
                                                Hi, {{ Auth::user()->name }}
                                            </span>
                                            <a href="/logout"
                                                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-white hover:bg-white/5">
                                                Logout
                                            </a>
                                        @else
                                            <a href="{{ route('login') }}"
...
@if (session('success'))
    <div class="p-3 bg-green-100 text-green-800 text-center text-sm">
        {{ session('success') }}
    </div>
@endif
